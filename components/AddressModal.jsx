...
const AddressModal = ({ open, setIsOpen, setUserAddress, userAddress }) => {
  const [selectedButton, setSelectedButton] = useState("Home");
  const [isOtherActive, setIsOtherActive] = useState(false);
  const [mapCenter, setMapCenter] = useState({ lat: 31.2529524, lng: 75.6982033 });
      ...
      >
        <div className={`rounded-md bg-white w-[1100px] h-auto flex`}>
          ...
          >
            <div className="h-auto w-3/5">
              ...
              >
                ...
                >
                  <input type="text" placeholder="Search a place" className="w-full p-2 border-2 border-gray-3000 rounded-md" />
                </Autocomplete>
                {markerPosition && (
          ...
          >
            ...
            <div className="mt-2">
              <Button onClick={handleSaveAddress} className="bg-green-4 text-white hover:bg-green-4 text-base font-bold">
                Save Address
              </Button>
            </div>
          </div>
