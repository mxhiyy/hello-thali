...
const IfUserAddress = ({ userAddress, setUserAddress }) => {
  ...
  return (
    <main className="p-5">
      ...
      {open && <AddressModal open={open} setIsOpen={setOpen} setUserAddress={setUserAddress} userAddress={userAddress} />}

      <div className="mt-10 flex justify-between">
        <div className="flex gap-2 items-center">
          {addressIcons[userAddress.type]}
          <div className="flex flex-col">
            <h1 className="text-base font-bold">{userAddress.type === "Other" ? userAddress.other : userAddress.type}</h1>
        ...
        <div className="">
          ...
          >
            <p className="text-base font-bold px-4 cursor-pointer hover:underline underline-offset-4 py-2 text-green-4" onClick={handleClick}>Edit</p>
          </Popover>
        </div>
      </div>
    </main>
