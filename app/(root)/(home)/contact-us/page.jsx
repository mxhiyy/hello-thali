      ...
      <div className="xl:flex xl:justify-between w-[90%] m-auto">
        ...
        <div className="mt-10">
          <form ref={form} onSubmit={sendEmail} className="text-base">
            {/* =============== name section ============= */}
            <label className="block md:inline-block font-bold mt-5 md:mr-40">
              Name*
            </label>
            <input
              name="user_name"
              className="p-2 w-[80vw] mt-2 border-2 border-gray-300 rounded-5 sm:w-[90vw] md:w-[70vw] xl:w-[25vw] bg-[#E9E8E8] placeholder:text-gray-400 hover:outline-none"
              type="text"
            ...
            <br />
            {/* ============== Email Section ============ */}
            <label className="block md:inline mt-5 md:mr-[10.1rem] font-bold">
              Email*
            </label>
            <input
              name="user_email"
            ...
            <br />
            {/* ============== Question Section ============ */}
            <label className="block md:inline-block mt-5 md:mr-[7.4rem] md:float-start font-bold">
              Description*
            </label>
            <textarea
              name="user_message"
              className="p-2 w-[80vw] mt-2 border-2 border-gray-300 rounded-5 placeholder:text-gray-400 hover:outline-none sm:w-[90vw] md:w-[70vw] xl:w-[25vw] bg-[#E9E8E8]"
              type="text"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-green-4 bg-opacity-65 hover:bg-green-4 flex text-base  justify-center mb-5 text-white p-2 rounded-md w-30 sm:w-40 xl:mt-5 xl:w-[11rem]"
              >
                Submit
              </button>
            </div>
        ...
        <div
          className="hidden xl:flex xl:justify-center xl:items-center w-1/2"
        ...
        >
          <div className="w-[300px] h-[250px] shadow-lg rounded-5 bg-[#7997000F] text-black">
            ...
            <p className="flex items-center mb-4 ml-7 text-xl">
              ...
              <Link href={"mailto:info@hellothali.com"}>
                info@hellothali.com
              </Link>
            </p>
            <p className="flex items-center mb-4 ml-7 text-xl">
