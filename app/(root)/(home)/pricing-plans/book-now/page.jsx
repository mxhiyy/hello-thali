  ...
  return (
    <main>
      <div className="w-[90%] m-auto bg-[#F8F8F8AD] h-full p-3 flex flex-col gap-3 rounded-md">
        <h1 className="font-normal text-6xl text-center text-green-5">
          How We Offer Customisation?
        </h1>
        <h6 className="text-center text-[#A31111] font-semibold text-3xl">
          Just like our mom does in our family.
        </h6>
        <p className="text-center text-lg font-semibold w-[80%] m-auto">
          In each thali you get some item permanently such as Roti, Rice, Boondi
          Raita, Pickel/Chatni, Salad, Dal. Apart from that we offer
          customisation of one main sabji to our customers. You can choose any
          one sabji for any week-days and Submit the preferences.{" "}
        </p>
      </div>
      ...
      <div className="grid grid-cols-7 grid-rows-1 w-[90%] m-auto mt-20">
        {buttons.map((data) => (
          <Button
            className={`text-lg font-semibold w-32 text-white  ${
              selectedButton === data.name
                ? "bg-[#082206BA] hover:bg-[#082206BA]"
                : "opacity-65 bg-green-4 hover:bg-green-4"
            } hover:text-white`}
            key={data.id}
      ...
      <p className="text-sm font-medium w-[90%] m-auto mt-5">
        <span className="font-bold">Note : </span>Currently We Are Serving Only
        Dinner , Once We Become Operationally Efficient, We Will Expand To Lunch
        & Breakfast.
      </p>
        ...
        {!loading && selectedButton && (
          <div className="grid grid-cols-3 grid-rows-2 w-[90%] m-auto mt-20 gap-40">
            {orderNowCard[selectedButton].map((data) => (
              <div
                className="rounded-md w-[350px] h-[430px] p-3 relative"
              ...
              >
                ...
                <div className="mt-2 flex justify-between items-center">
                  ...
                  <p className="font-semibold text-[#FF0000FA] text-sm">
                    {data.main}
                  </p>
                </div>
                ...
                <div className="flex justify-between items-center w-[90%] absolute bottom-2">
                  ...
                  <Button className="bg-green-4 opacity-65 text-white font-semibold text-lg">
                    Add
                  </Button>
                </div>
              </div>
      ...
      <div className="mt-20 w-[90%] m-auto">
        <h1
          className="text-green-5 text-center font-normal text-4xl"
          style={{ fontFamily: "Inter" }}
        >
          Tabular Representation of Your Preferences
        </h1>
      </div>
            ...
            <TableRow>
              {tableData.map((data) => (
                <TableCell
                  ...
                  className="font-semibold text-xs p-3 bg-opacity-60"
                >
                  {data.heading}
                </TableCell>
              ))}
      ...
      <div className="w-[90%] m-auto flex flex-col gap-3 mt-10">
        <div className="flex gap-2 items-center">
          ...
          >
            I understand that the term “Both” in the Tabular representation
            means “3 Roti and Half-Bowl Rice Combined”.
          </label>
        </div>
      ...
      <div className="w-[90%] m-auto bg-[#7997000F] h-full mt-20 flex flex-col gap-10 p-5 rounded-md">
        <h1 className="text-4xl font-bold">
          Need Help? Do not hesitate Dialing us: +91 80033XX57XX4
        </h1>
        <div className="flex flex-col gap-2">
          <h1 className="text-4xl font-bold">
